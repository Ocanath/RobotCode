...
void move_servos(int * servo_list, int * b, int * m, int * t, int * c, int cycles)
{
    ...
    servo_list[0] = c[1];   //pin 4
	
    
	servo_list[14] = m[2]; //pin 30
	servo_list[12] = t[2] + 75; // top pin 24
	servo_list[19] = b[2]; //bottom     //pin 27                                                                                                                                                                                                                                           
    servo_list[7] = c[6];
    ...
    servo_list[11] = m[5]; //middle     pin 23
	servo_list[13] = t[5]; // top       pin 33
	servo_list[21] = b[5]; //bottom     pin 28
	servo_list[9] = c[5];
	
    
    servo_list[23] = m[6]; //middle	//pin 58
	servo_list[4] = t[6]; // top	//pin 48
	servo_list[5] = b[6]; //bottom	//pin 37
	servo_list[17] = c[2];
...
servo_list[18] = m[1]; //middle 	//pin 43
    ...
    servo_list[5] = m[6]; //middle	//pin 58
	servo_list[4] = t[6]; // top	//pin 48
	servo_list[23] = b[6]; //bottom	//pin 47
	servo_list[17] = c[2];
...
void Snowflake_Leg_Limit_Joints(double * Theta)
{
