#ifndef SNOWFLAKE_CONTROL_FUNCTIONS_H
#define	SNOWFLAKE_CONTROL_FUNCTIONS_H
...
//typedef struct SnowflakeMotors
//{        
//    int timearr[24];
//    int b[7];
//    int m[7];
