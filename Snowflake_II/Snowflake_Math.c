...
void Snowflake_Leg_Forward_Kinematics(double * Theta, double H0_1[4][4], double H1_2[4][4], double H2_3[4][4], double alpha1, double alpha2, double alpha3, double a1, double a2, double a3, double H0_2[4][4], double H0_3[4][4])
{
...
void Snowflake_Leg_Inverse_Kinematics(double X_desired, double Y_desired, double Z_desired, double XROT_desired, double YROT_desired, double ZROT_desired,
	...
	double * XVS, double * YVS, double * ZVS, double * XROTVS, double * YROTVS, double * ZROTVS, double weight)
{
	...
	SnowflakeJacobianTranspose(J, J_T);
...
void SnowflakeJacobianTranspose(double HTin[6][3], double HTout[3][6])
{
    int r, c;
	for (r = 0; r < 6; r++)
	{
